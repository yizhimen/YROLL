...
def build_tools(server: "McpServer") -> dict[str, dict]:
    ...
    tools = {
        ...
        "yroll_trim": t_mut("yroll_trim", "裁剪 clip 的源区间（GUI-02: frame-native）",
            "/clips/{clip_id}/trim",
            {"clip_id": s, "new_source_start_frame": n, "new_source_end_frame": n, "why": s},
            ["clip_id"]),
        "yroll_split": t_mut("yroll_split", "在 timeline frame 切开 clip（GUI-02: frame-native）",
            "/clips/{clip_id}/split",
            {"clip_id": s, "at_timeline_frame": n, "why": s},
            ["clip_id", "at_timeline_frame"]),
        "yroll_move": t_mut("yroll_move", "移动 clip 到时间轴新位置（GUI-02: frame-native）",
            "/clips/{clip_id}/move",
            {"clip_id": s, "new_timeline_start_frame": n, "new_track_id": s, "why": s},
            ["clip_id", "new_timeline_start_frame"]),
